...
/**
 * This class is a question type that can be used to ask Mutiple Choice question. It implements Question interface 
 * and extends from MultipleSetting.
 */
public class MultipleChoice extends MultipleSetting implements Question{
    private static final int PRIORITY_ID = 2; // priority
    /**
     * Constructors of MultipleChoice, which is inherits from MultipleSetting
    ...
    /** Overloading for MultipleChoice*/
    public MultipleChoice(String question, String answer,  
                          String option1,  String option2, String option3, 
                          String option4                                  ) {
    ...
    public MultipleChoice(String question, String answer,  
        ...
        super(question, answer, option1, option2, option3, option4, option5);
    }
    /** Overloading for MultipleChoice*/
    public MultipleChoice(String question, String answer, 
                          String option1,  String option2, String option3,
